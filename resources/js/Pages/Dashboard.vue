        ...
        <template>
            ...
            <li class="flex flex-row">
                ...
                <ul>
                    ...
                    >
                        <h2
                            class="ml-4 text-gray-600 text-3xl font-weight-bold"
                        >
                            Tasks
                        </h2>
                        <div class="px-64 py-8 bg-gray-300">
                            <div class="px-full shadow bg-grey-light">
                                <div
                                    class="bg-green text-s leading-none py-2 text-center text-white"
...
export default {
    ...
    computed: {
        progressClasses() {
            const progress = $page.user.dailypoints / 10;
